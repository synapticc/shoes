...
// src/Entity/Product/ProductImage/ProductImage4.php
...
use App\Repository\Product\ProductImage\ProductImage4Repository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

#[ORM\Entity(repositoryClass: ProductImage4Repository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'product_image4')]
class ProductImage4
{
    ...
    #[ORM\SequenceGenerator(sequenceName: 'product_image_pro_img4_id_seq', initialValue: 1, allocationSize: 1)]
    #[ORM\Column(name: 'pro_img4_id', type: Types::BIGINT)]
    ...
    #[ORM\OneToOne(targetEntity: ProductColor::class, inversedBy: 'productImage4', cascade: ['persist', 'remove'])]
