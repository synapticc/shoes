...
// src/Entity/Product/ProductImage/ProductImage2.php
...
use App\Repository\Product\ProductImage\ProductImage2Repository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

#[ORM\Entity(repositoryClass: ProductImage2Repository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'product_image2')]
class ProductImage2
{
    ...
    #[ORM\SequenceGenerator(sequenceName: 'product_image_pro_img2_id_seq', initialValue: 1, allocationSize: 1)]
    #[ORM\Column(name: 'pro_img2_id', type: Types::BIGINT)]
    ...
    #[ORM\OneToOne(targetEntity: ProductColor::class, inversedBy: 'productImage2', cascade: ['persist', 'remove'])]
