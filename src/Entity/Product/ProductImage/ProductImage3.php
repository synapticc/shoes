...
// src/Entity/Product/ProductImage/ProductImage3.php
...
use App\Repository\Product\ProductImage\ProductImage3Repository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

#[ORM\Entity(repositoryClass: ProductImage3Repository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'product_image3')]
class ProductImage3
{
    ...
    #[ORM\SequenceGenerator(sequenceName: 'product_image_pro_img3_id_seq', initialValue: 1, allocationSize: 1)]
    #[ORM\Column(name: 'pro_img3_id', type: Types::BIGINT)]
    ...
    #[ORM\OneToOne(targetEntity: ProductColor::class, inversedBy: 'productImage3', cascade: ['persist', 'remove'])]
